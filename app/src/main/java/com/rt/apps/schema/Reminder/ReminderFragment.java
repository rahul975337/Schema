...
import com.rt.apps.schema.Main.MainActivity;
...
public class ReminderFragment<MaterialSpinner> extends AppDefaultFragment {
    ...
    public static final String EXIT = "com.rahul.exit";
